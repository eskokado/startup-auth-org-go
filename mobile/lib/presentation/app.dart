...
class _AppRootState extends State<AppRoot> {
  ...
  Future<void> _load() async {
    // Para demo, lê user-id do armazenamento local futuramente; aqui usa placeholder
    const userId = 'USER_ID_LOCAL';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: const Text('Tasks'), actions: [IconButton(onPressed: _login, icon: const Icon(Icons.login))]),
        body: Padding(
